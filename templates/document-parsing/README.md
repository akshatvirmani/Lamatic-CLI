<a href="https://studio.lamatic.ai/_?wizardId=bundles-document-parsing" target="_blank" style="text-decoration:none;">
  <div align="right">
...
This bundle allows you to context engineer using an LLM from a PDF link into your vector database, and then allows to build a RAG chatbot to answer your question.

This includes a flow to context engineer and index documents, working together with then to build a RAG system powered by a RAG chatbot.
