<a href="https://studio.lamatic.ai/_?wizardId=bundles-semantic-search" target="_blank" style="text-decoration:none;">
  <div align="right">
...
This bundle allows you to vectorise from any data source into your vector database, and then allows to build a semantic search system to find content from your documnets.

This flow includes an option of integrating from  **7 indexation flows** working together with then to build a search system powered by a search widget.
